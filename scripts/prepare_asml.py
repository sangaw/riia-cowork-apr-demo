"""
Prepare ASML fully-featured CSV for the RITA dashboard.

Loads the raw ASML OHLCV CSV, computes all technical indicators on
the full history, and writes the combined result to rita_output/asml_merged.csv.

Usage:
    python scripts/prepare_asml.py
...
SOURCE_CSV = (
    ...
    r"\data\input\asml_2001-2026.csv"
)
OUTPUT_CSV = os.path.join(OUTPUT_DIR, "asml_merged.csv")
